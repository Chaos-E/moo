...
document.getElementById('random-image').addEventListener('transitionend', function() {
    ...
    instruction.style.zIndex = 2; // set link above the image
    instruction.style.opacity = '1'; // set link opacity to 1 (visible)
    instruction.style.transition = 'opacity 1s'; // Add transition to the link
});
