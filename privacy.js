...
document.querySelector('.privacy-text').addEventListener('mouseover', function() {
    this.textContent = 'Moo Home';
    this.href = "home.html"; //  home URL here
    this.style.color = '#fff';
    this.style.textShadow = '0 0 1px black, 0 0 1px black';
});

document.querySelector('.privacy-text').addEventListener('mouseout', function() {
